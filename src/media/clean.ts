...
export interface CleanOptions {
  hideScrollbars?: boolean   // default: true for web
  cleanStatusBar?: boolean   // default: true for ios/watchos
  hideCursor?: boolean       // default: true for web
...
async function defaultCommandRunner(cmd: string, args: string[]): Promise<void> {
...
export async function prepareForCapture(
  ...
  if (platform === 'web') {
    if (!conn || !sessionId) return state
...
export async function restoreAfterCapture(state: CleanState): Promise<void> {
