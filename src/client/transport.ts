...
export class SocketConnectionError extends Error {
  ...
  constructor(message: string, opts?: { cause?: Error; code?: string }) {
    super(message)
 ...
 */
export function socketRequest(opts: SocketRequestOptions): Promise<SocketResponse> {
  ...
  return new Promise<SocketResponse>((resolve, reject) => {
    ...
    req.on('error', (err: NodeJS.ErrnoException) => {
      if (err instanceof SocketConnectionError) { reject(err); return }
      const code = err.code
