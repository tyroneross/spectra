...
function mapCapture(args: Args): MappedCall {
...
function mapSession(args: Args): MappedCall {
...
function op(operation: CoreApiOperation, params: Record<string, unknown> | undefined): MappedCall {
 ...
 */
export async function forwardTool(client: DaemonClient, toolName: string, args: Args = {}): Promise<unknown> {
