 ...
 */
export function buildDarkSpotlightFilter(opts: SpotlightStageOptions): string {
 ...
 */
export async function renderSpotlightPrePass(opts: SpotlightPrePassOptions): Promise<string> {
...
export async function cleanupSpotlightPrePass(path: string): Promise<void> {
