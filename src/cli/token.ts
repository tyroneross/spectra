 ...
 */
export function getOrCreateDaemonToken(overrideHome?: string): TokenInfo {
...
export function tokenMatches(headerValue: string | undefined, token: string): boolean {
...
export function tokenFileMode(path = TOKEN_PATH): number {
