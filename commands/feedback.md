---
name: feedback
description: Report a bug or send feedback about the spectra plugin
---

# Report spectra feedback

File the user's report as a GitHub issue on `tyroneross/spectra`. Issues are this plugin's
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/spectra/issues/new
