...
// ─── Perceptual Hash ─────────────────────────────────────────
export function perceptualHash(pngBuffer) {
...
export function diffSnapshots(before, after) {
    ...
    for (const [key, afterEl] of afterMap) {
        ...
        const boundsDiff = Math.abs(ax - bx) > 5 ||
            Math.abs(ay - by) > 5 ||
            Math.abs(aw - bw) > 5 ||
            Math.abs(ah - bh) > 5;
        if (boundsDiff) {
        ...
        else if (afterEl.value !== beforeEl.value ||
...
// ─── Detect Change ───────────────────────────────────────────
export function detectChange(beforeBuffer, afterBuffer, beforeSnap, afterSnap, threshold) {
