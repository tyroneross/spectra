...
export function resolveFlipTopologyPlistPath(homeDir = homedir()) {
...
export function isFlipTopologyInstalled(homeDir) {
    return existsSync(resolveFlipTopologyPlistPath(homeDir));
}
const FLIP_TOPOLOGY_DECLINE_MESSAGE = '[spectra] daemon is launchd-managed under the M3.G1 flip topology ' +
